<!-- Footer -->
<footer class="page-footer stylish-color-dark text-center text-md-left mt-0 pt-4 "  style="padding-top: 0px; padding-left:0;">
    ...
    <div class="container">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <img style=" height: auto !important; width: 60px !important; " src="" />
            </h6>
            <p style="font-size: 18px !important;">
            VQA is a Computer vision task where a system is given a text-based question about an image, and it must infer the answer.
            </p>
        </div>
        <!-- First column -->
